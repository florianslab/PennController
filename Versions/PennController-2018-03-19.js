...
(function(){
    ...
    function _addElementTo(element, to) {
    ...
    function _addPreloadedFile(file, element) {
        ...
        //console.log("Just added "+file+" to _preloadedFiles");
    ...
    class Instruction {
        ...
        run() {
            ...
            console.log("Running "+this.type+" with "+this.origin.content);
        }
        ...
        extend(method, code) {
            console.log("Extending "+this.origin.content+"'s "+method+" with "+code.toString());
            let ti = this, m = ti[method];
            return function(){
                console.log("Extension of "+method+" for "+ti.origin.content+" ("+ti.type+")");
        ...
        newMeta(callback, before) {
            ...
            instr.run = function(){
                ...
                console.log("Running "+instr.origin.content+" (META)");
                instr.before();
    ...
    class ComplexInstr extends Instruction {
        ...
        _executed(instruction) {
            ...
            console.log("Instruction just executed");
            console.log("toBeDone's length: "+this.toBeDone.length);
                    ...
                    ti.origin.player = new YT.Player(code, {
                        ...
                        events: {
                            ...
                            'onStateChange': function(event){ 
                                console.log("Change of STATE for "+code+": "+event.data);
